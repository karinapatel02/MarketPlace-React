...
function AddAd() {
    ...
    const createadd = async (e) => {
        ...
        try {
            ...
            console.log(ipdata);
            const { data } = await axiosconn.post('addAd', ipdata, {
                headers: {
                ...
                <form className="add-product" onSubmit={createadd}>
                    <div className="form-row">
                        ...
                        <div className="form-inputs">
                            <input name="adname" placeholder="Name of Ad" onChange={onChange} required></input>
                        </div>
                    </div>
                    <div className="form-row">
                        <div className="form-labels">
                        ...
                        <div className="form-inputs">
                            <textarea name="desc" placeholder="Description of Ad" onChange={onChange} required></textarea>
                        </div>
                    </div>
                    <div className="form-row">
                        <div className="form-labels">
