...
function AddProduct() {
    ...
    const addImg = async (e) => {
        ...
        setFormData({ ...addProductForm, img: base64 });
    };
                ...
                <form className="add-product" onSubmit={addProduct}>
                    <div className="form-row">
                        ...
                        <div className="form-inputs">
                            <input type="text" id="pname" name="productname" placeholder="Name of Product" onChange={onChange} />
                        </div>
                    </div>
                    <div className="form-row">
                        <div className="form-labels">
                    ...
                    <div className="form-row">
                        ...
                        <div className="form-inputs">
                            <input type="number" id="price" name="quantity" defaultValue="0" placeholder="Quantity" onChange={onChange} />
                        </div>
                    </div>
                    <div className="form-row">
